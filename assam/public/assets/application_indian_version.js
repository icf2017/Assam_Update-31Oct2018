 ...
 $(document).ready(function()
    ...
    $(window).scroll(function(){
	 ...
	 {		
			...
			var ss = $('#highcharts-52 #custom-legend1 .legend-item6').text();
		console.log(ss);
	});
...
$(document).ready(function()
	 {		
		...
		{
			var ki = $(this).val();
			if(ki == '1120112112121111011111111102011110111111111110112011102') /*--------all level 1-----------*/
			{
				$('#c32l1').css('background-color','#F44545');
				$('#c32l2').css('background-color','transparent');
				$('#c32l3').css('background-color','transparent');
				$('#c32l4').css('background-color','transparent');
				
				$('#c27l1').css('background-color','#FFAE55');
				$('#c27l2').css('background-color','#FFAE55');
				$('#c27l3').css('background-color','transparent');
				
				
				$('#rew_ch_val').text("4.0 th ha");
				$('#con_ch_val').text("0.5 th ha");		
				$('#bio_ch_val').text("1.2 th ha");
			}
			
			else if(ki == '4440444444444444044444444402044440443444444440442044402') /*--------all level 4s-----------*/
			{
				...
				$('#rew_ch_val').text("30.5 th ha");
				$('#con_ch_val').text("2.5 th ha");		
				$('#bio_ch_val').text("12.6 th ha");
			}
			
			else if(ki == '3320332332323333033333333302033330333333333330332033302') /*--------all level 3s-----------*/
			{
				...
				$('#rew_ch_val').text("21.2 th ha");
				$('#con_ch_val').text("2.0 th ha");		
				$('#bio_ch_val').text("8.2 th ha");
			}
			
			else if(ki == '2220222222222222022222222202022220222222222220222022202') /*--------all level 2s-----------*/
			{
				$('#c32l1').css('background-color','#FFAE55');
				$('#c32l2').css('background-color','#FFAE55');
				$('#c32l3').css('background-color','transparent');
				...
				$('#rew_ch_val').text("12.2 th ha");
				$('#con_ch_val').text("1.4 th ha");		
				$('#bio_ch_val').text("3.6 th ha");
			}
			
			else if(ki == '2220222222222222022222222202022220222222221120222022202') /*--------Deafault-----------*/
			{
				$('#c32l1').css('background-color','#FFAE55');
				$('#c32l2').css('background-color','#FFAE55');
				$('#c32l3').css('background-color','transparent');
			...
			else if(ki == '11201222224244420323233222020222402422222211202420242022222') /*--------Maximum RE and Electic Vehicle Pathway-----------*/
			{
				$('#c32l1').css('background-color','#92C979');
				$('#c32l2').css('background-color','#92C979');
				$('#c32l3').css('background-color','#92C979');
				...
				$('#rew_ch_val').text("12.6 th ha");
				$('#con_ch_val').text("0.7 th ha");		
				$('#bio_ch_val').text("7.0 th ha");
			}
			
			else if(ki == '22201122221224320223223222020222202222222211202220222022222') /*--------State Vision PAthway-----------*/
			{
				$('#c32l1').css('background-color','#FFAE55');
				$('#c32l2').css('background-color','#FFAE55');
				$('#c32l3').css('background-color','transparent');
				...
				$('#rew_ch_val').text("11.7 th ha");
				$('#con_ch_val').text("1.4 th ha");		
				$('#bio_ch_val').text("6.6 th ha");
			}
			
			else if(ki == '11104422424244420414314222020444404422242442404420442022222') /*--------Re Push and Low-----------*/
			{
				$('#c32l1').css('background-color','#92C979');
				$('#c32l2').css('background-color','#92C979');
				$('#c32l3').css('background-color','#92C979');
				...
				$('#rew_ch_val').text("30.5 th ha");
				$('#con_ch_val').text("0.9 th ha");		
				$('#bio_ch_val').text("11.4 th ha");
			}
...
$(document).ready(function()
{
	...
	$("#pathway_option").change(function()
	{
		...
		if(vals == '1120112112121111011111111102011110111111111110112011102') /*---------All level 1--------*/
		{
			$('#trans_range').val('1');
			$('.tran_val').html('1'); 
		...
		else if(vals == '3320332332323333033333333302033330333333333330332033302') /*---------All level 3--------*/
		{
			$('#trans_range').val('3');
			$('.tran_val').html('3'); 
		...
		else if(vals == '22201122221224320223223222020222202222222211202220222022222') /*---------State Vision Pathway--------*/
		{
				$('#trans_range').val('2');
			$('.tran_val').html('2'); 
		...
		else if(vals == '11104422424244420414314222020444404422242442404420442022222') /*---------Re Push and Low Emissions Pathways --------*/
		{
				$('#trans_range').val('4');
			$('.tran_val').html('4'); 
			...
			else if(vals == '11201222224244420323233222020222402422222211202420242022222') /*--------Maximum RE and Electic Vehicle Pathway--------*/
		{
				$('#trans_range').val('3');
			$('.tran_val').html('3'); 
